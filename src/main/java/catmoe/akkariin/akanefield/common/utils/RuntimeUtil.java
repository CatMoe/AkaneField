...
public class RuntimeUtil {
    ...
    public static Process execute(String... command) {
        try {
            ...
            instance.getLogHelper().error("An error occurred while dispatching: " + Arrays.toString(command)
    ...
    public static String executeAndGetOutput(String command) {
        try {
            ...
            instance.getLogHelper()
                    .error("An error occurred while dispatching: " + command + ", message -> " + e.getMessage());
        }
        return "";
    }
}
