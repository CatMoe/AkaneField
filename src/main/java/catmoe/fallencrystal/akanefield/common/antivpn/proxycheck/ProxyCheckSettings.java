package catmoe.fallencrystal.akanefield.common.antivpn.proxycheck;
...
public class ProxyCheckSettings {
     ...
     * and present you with the provider name, ASN, Continent, Country, Country
     * ISOCode, Region, Region ISOCode, City (if it's in a city) and Lat/Long for
     * the IP Address.
     *
     * Provider, Country, Region and City names will be encoded using utf8 for
    ...
    /**
     * When the risk flag is set to 1 we will provide you with a risk score for this
     * IP Address ranging from 0 to 100.
     ...
     *
     *
     * When the risk flag is set to 2 we will still provide you with the above risk
     * score,
     * but you'll also receive individual counts for each type of attack we
     * witnessed this IP performing across our customer
     ...
     * now and the amount of days you specify.
     * For example if you supplied days=2 we would only check our database for
     * Proxies that we saw within the past 48 hours.
     ...
     * supply. You can supply your tag using the POST method, and we recommend you
     * do so.
     * 
    ...
    /**
     * Override the API version selection you have set in the customer dashboard
