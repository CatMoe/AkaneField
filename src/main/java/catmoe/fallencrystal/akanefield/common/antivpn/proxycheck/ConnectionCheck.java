...
import catmoe.fallencrystal.akanefield.common.antivpn.proxycheck.query.HTTPQuery;
import catmoe.fallencrystal.akanefield.common.antivpn.proxycheck.result.ProxyResults;
...
public class ConnectionCheck {
    ...
    /**
     * Maps the results from the provided IP provided from the API to a class with
     * getters and setters
     * 
